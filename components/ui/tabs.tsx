...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-neutral-100 text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-2xl p-[3px]",
        className
      )}
      {...props}
    />
